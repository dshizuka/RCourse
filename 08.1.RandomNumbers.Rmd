---
title: "8.1. Randomizations: Sampling from sets and probability distributions"
author: "Dai Shizuka"
...
## 1. Combining apply and/or loops with `sample()`

### 1.1. Learning about `sample()` and `set.seed()`
