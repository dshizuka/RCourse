...
R is amazing for graphics. Once you learn how to play around with the codes, it is almost infinitely customizable.   
In this module, we will cover the basics of the plotting functions in the base package of R. There are many additional packages that help you produce fancier plots (e.g., 'ggplot2' and 'lattice'). We may cover ggplot2 later in the course.
