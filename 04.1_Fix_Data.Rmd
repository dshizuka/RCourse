...
There are a bunch of eggs that were apparently laid on May 18th and 19th, 2025! That can't be right... 

This can happen because of an "auto-fill" error in Excel. If the column is formatted to take mm/dd/yy and you only fill the month and date, it can auto-fill the year with the CURRENT YEAR, causing problems like this.

The best way to fix this problem is probably to go back to Excel and use the entry number--for example, if the data sequences goes "5/17/06", "5/18/25", "5/19/06", then you probably entered "5/18/06" incorrectly. 
