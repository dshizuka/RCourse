...
### 3.2.3 Check if you now have Git installed

If you've installed a Git Client, it probably installed Git on your computer also. But let's check to make sure.
...
### 3.2.6. Make a repository ("repo") on on GitHub.
