...
dat=read.csv("/Users/dshizuka/Downloads/SampleData.csv")
```
...
### 3.4. Make a repository ("repo") on on GitHub and clone it to your computer.

**If you are doing this for the BIOS967 course, log into the BIOS967 organization on github here: [https://github.com/BIOS967](https://github.com/BIOS967). If you're just doing this independently, you can just log into github normally.**
...
Let's open a repository on GitHub Desktop. Here, we'll start by using a repository that you've already cloned onto your computer.
...
Once you do this, any changes you make to your local files that are not yet pushed to GitHub will appear on the right-hand side of the window. 
