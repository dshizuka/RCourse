...
```{r}
# unl=data.frame(campus="UNL", long=-96.7004763, lat=40.8201966 )
# 
# uni_sf=st_as_sf(unl, coords=c("long", "lat"))
# st_crs(uni_sf)=st_crs(ne_full2024)
# # 
# ggplot() +
#   geom_sf(data=ne_full2024) +
#   geom_sf(data=uni_sf, aes(color=campus)) +
#   theme_bw()
```
