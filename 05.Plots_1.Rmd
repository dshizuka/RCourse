...
* **Continuous data** are quantitative measurements that can take any value. That is, it can be divided and reduced to finer levels. For example, take weight, height, or length.  

* **Count data** or frequencies are also quantitative measurements, but they cannot be divided into smaller levels. They are counts of whole things. These are typically integers. 

* **Categorical data** are *qualitative data* are characteristics, descriptors or labels that are not numerical. 
