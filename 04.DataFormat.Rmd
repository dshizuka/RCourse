...
***
## 4.3. Wide- vs. Long-format data

The most important thing to keep in mind is that your data should contain **each observation as a separate row**. For example, each subject should be a separate row. 
What if you have repeated measurements from the same subject (e.g., individual)? Then, you have two different optoins, **wide-format** and **long-format**. 

I won't say that wide- or long-format is the *right* way... THOUGH some people will tell you to never use wide-format. The reality is, in some cases it is easier to enter data and make sense of your data in a wide-format. However, in some cases, analysis and plotting will be easier when you have data in long-format. For practical purposes, I have found that knowing how to go back and forth between these formats helps you make the most out of your data. 

For example, this is an example of a **wide-format** dataframe:  
...
Here is the same data, organized in a **long-format**
