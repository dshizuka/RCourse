...
* 8/29/19: **Assignment 1** Here is the [assignment file](pdf_versions/Assignment1.pdf) and an [example assignment folder](data/Assignment1_example.zip). This file includes a sample dataset and a sample readme file.
