...
* The course will consist of one 3-hour session per week. 
* Class sessions will consist of live-coding sessions led by the instructor, as well as individual and group exercises.
* Each class session will have a handout that provides details and codes. These are designed to be guides that will help you retain the information in the future. Compiled together, this will essentially be your textbook.
* Most weeks, there will be a homework assignment. Sometimes this will entail generating and submitting code scripts. Other times, it will require you to prepare data, look up literature, or other tasks.
...
3. **Bookmark the Course Etherpad**  
*Etherpad* is a super useful way to follow along with the codes in real time. We will use this site in class. I have created a course "pad". You should bookmark this url in your favorite browser: [https://public.etherpad-mozilla.org/p/rcoursepad](https://public.etherpad-mozilla.org/p/rcoursepad)
