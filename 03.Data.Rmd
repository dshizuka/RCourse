...
###3.2 Five ways to import .csv (or .txt) files
...
Using this, I can read in the .csv file using a function called `read.csv()`
...
For example, if you right-click on the link up above to download the "SampleData.csv" file (under 3.1: Importing Data), you can "copy link" and get this url:
`http://127.0.0.1:31115/rmd_output/1/data/SampleData.csv`
