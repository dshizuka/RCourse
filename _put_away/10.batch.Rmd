---
title: 'Module 10. Batch Processing:'
...
map=get_stamenmap(bbox=c(left=-1.5, bottom=51.7, right=-1.2, top=51.9), zoom=10, source="stamen", maptype="terrain-background", filetype="png")
