...
1. [A reproducibility document from Shizuka & Hudson (2020) in which we used a model to describe how the threshold of species recognition evolves. Look at it](rmd_examples/Shizuka_Hudson_supplemental_materials.html)

2. [Supplemental Materials from Shizuka et al. (2022), which describes the complete workflow for a creating social networks from automated telemetry data.](rmd_examples/Shizuka_etal_2022_Telemetry_AppendixS1.html)
...
* Go to [this page](11.e.RMDExercise.html) and try to recreate this page using RMarkdown! 
