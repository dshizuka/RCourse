...
### <u>Evaluation</u>  
Students will be evaluated based on 4 criteria. (1) Participation [15 points], (2) Presentations [15 points], (3) Take-home assignments [20 points], (4) Project proposal [15 points], (5) Write-up of independent project [35 points].
...
* Week 2 (Aug 30, Sep 1): Data Wrangling & Plotting basics

* Week 3 (Sep 6, 8): Some simple statistics

* Week 4 (Sep 13, 15): Data Wrangling & Plotting in Tidyverse

* Week 5 (Sep 20, 22): Creating reports; **(Thursday independent work)**

* Week 6 (Sep 27, 29): Resampling, bootstrapping 

* Week 7 (Oct 4, 6): apply functions, loops, statements; **(Thursday independent work)**

* Week 8 (Oct 11, 13): Simulations, stochasticity, **Submit proposal for independent project**

* Week 9 (Oct 20): **Fall Break (Tuesday 18th)**; Write your own functions (Thursday)

* Week 10 (Oct 25, 27): Batch processing
