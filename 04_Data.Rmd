...
In R, you also have the option of "loading" an .rdata file format, which is a binary file format used by the R programming language. .Rdata files can store multiple objects. together. 
