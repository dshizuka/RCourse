...
***If you have a continuous predictor AND continuous response variable...*** Linear regression or Generalized Linear Model (GLM) with Gaussian distribution

***If you have a continuous predictor AND binary response variable...*** GLM w/ "binomial" family (aka logistic regression)

***If you have a continuous predictor AND counts as response variable...*** GLM w/ "Poisson" family (aka Poisson regression)

***If you have a continuous predictor AND proportions as response variable...*** GLM w/ "binomial" or Quasi-binomial" family

***If you have a categorical predictor AND continuous response variable...*** ANOVA (or t-test, if you are just comparing means), which can be run as linear model or GLM.
