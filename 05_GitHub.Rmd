...
I would like for you to enable email notification so that we can communicate on your repository. Go to "setting", then find "email notifications" at the bottom of the left navigation panel. Add your email. 

### Create a RStudio Project directory.
...
## 4. Working with GitHub: Pull, Stage, Commit, Push with GitHub Desktop
...
## 5. Working together remotely: Branches, issues and Pull Requests

For a large chunk of this course, we will be holding "work sessions" in class where I can help you work through issues. However, in some cases we may need to work together remotely. Luckily, GitHub provides nice tools that allows us to do this. 

```{r, echo=F, out.width="125%"}
knitr::include_graphics("images/branch_merge.png")
```


Here is how I envision us working together on independent projects in this course (refer to image above). 

### 1. (You) create an "issue":

If you run into any challenges, or if you simply want to update me about something, you can create an 'issue' message on GitHub. There are a couple of ways you can do this:

* In GitHub Desktop, go to "Repository" > "Create Issue on GitHub" (or simply click "command-I" on a Mac)

* Go to your repository on GitHub, click on the "Issues" tab on the top, click it, then find the green "New issue" button.

```{r, echo=F, out.width="100%"}
knitr::include_graphics("images/GitHub_issue.png")
```
You can include images (e.g., screenshots) or other files in your message (if they don't appear in your repository, for example).

### 2. (Instructor) responds and looks at your repo on the 'instructor branch'

Once I get your message, I will either just respond back with a message, or I can examine the problem by looking into your data, code, etc. 

To avoid inadvertently messing up your code, I will create a new "branch"--i.e., a version of your repository that I can mess around with, that won't automatically appear on your "master" branch. There, I may make some changes, like write suggested lines of code, etc. 

### 3. (Instructor) creates a 'pull request' to you

If I manage to figure out the problem, I can make suggestions in two ways. (1) I can simply message you back with suggestions for what you can do, or (2) if I have suggested edits to your code, I will make a 'pull request'. This send you a message that you've received a pull request. Then, you can review the edits I've made and, and you can accept those changes by clicking "merge pull request"
