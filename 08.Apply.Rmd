---
title: 'Module 8: Random Numbers, Apply, and Loops' 
author: "Dai Shizuka"
...
The essence of stochasticity is that a parameter will vary randomly--but ***what do we mean by random!?***
If you think about it, there is an infinate number of ways to sample a random set of numbers[^1]. Let's consider some options:
...
###9.1.4 Table of probability distributions
...
###8.2.2 `tapply()` (and comparing it to `aggregate()`)
...
###8.2.3 Working with arrays using `apply()`
...
####8.3.2 Practice with for-loops: The P-value
