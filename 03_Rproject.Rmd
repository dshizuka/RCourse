...
Reading about all of this is one thing, but you'll actually learn how this works by using it! So, let's set up an RStudio Project directory that you will use for the rest of the lectures for this course. **Please follow these directions and set up your folder exactly the same way, with exactly the same folder names (including capitalization).** If you don't use the same structure and names for your folders, it will cause problems later!

### 3.1. Setting up a new Rstudio project folder the course lectures.

1. Create a folder called "BIOS967_lectures" on your computer.

2. Next, in R Studio, click on "File" > "New Project" 

3. Click on "Existing Directory", click "Browse" and select the "BIOS967_lectures" Folder you created, then click "Create Project"

4. Now, you will see that there is a new "BIOS967_lectures.rproj" file in your folder.
...
6. Create a "data" folder with all data needed for all learning modules.
  ...
  * "Decompress" or "unzip" the file. This will create a folder called "data". Move this folder into your "BIOS967_lectures" folder. 

  * Now, in RStudio, click on the "refresh" button ![](images/Rstudio_refresh.png) on the far right side of your "Files" window on the bottom-right part of your Rstudio window. You should now see that there is a "data" folder in your project directory, and that there are a bunch of different files in that folder. 
